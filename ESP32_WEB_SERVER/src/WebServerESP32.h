...
#include <Arduino.h>
    ...
    <body>
        ...
        <script>
            ...
            //add html da tao vao trang web chinh
                        ...
                        if (xhttp.readyState === 4) {
                            if (xhttp.status === 200) {
                                try {
                                    ...
                                    state_control_speed = JsonData.CS;
                                } catch (error) {
            ...
            window.addEventListener("load", function () {
                addGPIOItems(13); addGPIOItems(14); addGPIOItems(16); addGPIOItems(17);
                addGPIOItems(18); addGPIOItems(19); addGPIOItems(32); addGPIOItems(33);
                addGPIOItems(34); addGPIOItems(35); addGPIOItems(36); addGPIOItems(39);
            });
